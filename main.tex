...
\emph{\href{https://liiistem.cn/}{Liii STEM} is a WYSIWYG \TeX-style editor. All \LaTeX command mentioned in this cheatsheet works in Liii STEM. Therefore, the user can choose to use shortcuts or \LaTeX commands.}
