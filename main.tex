...
\emph{We distinguish the capital and noncapital letters in this cheatsheet; For example, \keys{J} and \keys{j} are different. We also use \keys{\shift j} to replace \keys{J} where \keys{\shift} represents the \texttt{Shift} key.}
